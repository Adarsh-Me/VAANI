...
/** Bundled hi/ta/bn/gu demo phrasebook. Normalizes punctuation before lookup. */
object DemoPhrasebook {
    private data class Triple3(val hi: String, val ta: String, val bn: String, val gu: String = "")

    private val PHRASES = listOf(
        Triple3("मुझे मदद चाहिए", "எனக்கு உதவி தேவை", "আমার সাহায্য দরকার", "મને મદદ જોઈએ"),
        Triple3("पानी बहुत तेज़ है", "தண்ணீர் மிகவும் வேகமாக உள்ளது", "জল খুব দ্রুত বাড়ছে", "પાણી ખૂબ ઝડપથી વધી રહ્યું છે"),
        Triple3("खतरा है यहाँ से हटें", "ஆபத்து இங்கிருந்து விலகுங்கள்", "বিপদ এখান থেকে সরে যান", "ખતરો છે અહીંથી ખસો"),
        Triple3("डॉक्टर चाहिए", "மருத்துவர் தேவை", "ডাক্তার দরকার", "ડૉક્ટર જોઈએ"),
        Triple3("सब सुरक्षित हैं", "அனைவரும் பாதுகாப்பாக உள்ளனர்", "সবাই নিরাপদে আছে", "બધા સુરક્ષિત છે"),
        Triple3("हाँ", "ஆம்", "হ্যাঁ", "હા"),
        Triple3("नहीं", "இல்லை", "না", "ના"),
        Triple3("आप कहाँ हैं", "நீங்கள் எங்கே இருக்கிறீர்கள்", "আপনি কোথায় আছেন", "તમે ક્યાં છો"),
        Triple3("खाना चाहिए", "உணவு தேவை", "খাবার দরকার", "જમવાનું જોઈએ"),
        Triple3("शांत रहें", "அமைதியாக இருங்கள்", "শান্ত থাকুন", "શાંત રહો"),
        Triple3("बचाव दल आ रहा है", "மீட்புக் குழு வருகிறது", "উদ্ধারকারী দল আসছে", "બચાવ દળ આવી રહી છે"),
        Triple3("नमस्ते", "வணக்கம்", "নমস্কার", "નમસ્તે")
    )
    ...
    private val WORDS: Map<Pair<String, String>, Map<String, String>> = mapOf(
        ...
        ("hi" to "gu") to mapOf(
            "पानी" to "પાણી", "मदद" to "મદદ", "खतरा" to "ખતરો",
            "डॉक्टर" to "ડૉક્ટર", "सुरक्षित" to "સુરક્ષિત", "हाँ" to "હા",
            "नहीं" to "ના", "खाना" to "જમવાનું", "नमस्ते" to "નમસ્તે",
            "मेरा" to "મારું", "मेरी" to "મારું", "नाम" to "નામ",
            "मैं" to "હું", "तुम" to "તું", "आप" to "તમે",
            "और" to "અને", "बहुत" to "ખૂબ", "कहाँ" to "ક્યાં",
            "क्या" to "શું", "चाहिए" to "જોઈએ", "चाहिये" to "જોઈએ",
            "यहाँ" to "અહીં", "वहाँ" to "ત્યાં", "से" to "થી",
            "बचाव" to "બચાવ", "दल" to "દળ", "शांत" to "શાંત",
            "सब" to "બધા", "घर" to "ઘર", "आग" to "આગ", "बाढ़" to "પૂર"
        ),
        ("gu" to "hi") to mapOf(
            "પાણી" to "पानी", "મદદ" to "मदद", "ખતરો" to "खतरा",
            "ડૉક્ટર" to "डॉक्टर", "સુરક્ષિત" to "सुरक्षित", "હા" to "हाँ",
            "ના" to "नहीं", "જમવાનું" to "खाना", "નમસ્તે" to "नमस्ते",
            "મારું" to "मेरा", "નામ" to "नाम", "હું" to "मैं",
            "તું" to "तुम", "તમે" to "आप", "અને" to "और",
            "ખૂબ" to "बहुत", "ક્યાં" to "कहाँ", "શું" to "क्या",
            "જોઈએ" to "चाहिए", "અહીં" to "यहाँ", "ત્યાં" to "वहाँ",
            "બચાવ" to "बचाव", "દળ" to "दल", "શાંત" to "शांत",
            "બધા" to "सब", "ઘર" to "घर", "આગ" to "आग", "પૂર" to "बाढ़"
        ),
        ("ta" to "gu") to mapOf(
            "தண்ணீர்" to "પાણી", "உதவி" to "મદદ", "ஆபத்து" to "ખતરો",
            "மருத்துவர்" to "ડૉક્ટર", "ஆம்" to "હા", "இல்லை" to "ના",
            "உணவு" to "જમવાનું", "வணக்கம்" to "નમસ્તે",
            "என்" to "મારું", "பெயர்" to "નામ",
            "நான்" to "હું", "நீ" to "તું", "நீங்கள்" to "તમે",
            "எங்கே" to "ક્યાં", "என்ன" to "શું", "தேவை" to "જોઈએ",
            "மீட்பு" to "બચાવ", "குழு" to "દળ", "அமைதி" to "શાંત",
            "அனைவரும்" to "બધા", "வீடு" to "ઘર"
        ),
        ("gu" to "ta") to mapOf(
            "પાણી" to "தண்ணீர்", "મદદ" to "உதவி", "ખતરો" to "ஆபத்து",
            "ડૉક્ટર" to "மருத்துவர்", "હા" to "ஆம்", "ના" to "இல்லை",
            "જમવાનું" to "உணவு", "નમસ્તે" to "வணக்கம்",
            "મારું" to "என்", "નામ" to "பெயர்",
            "હું" to "நான்", "તું" to "நீ", "તમે" to "நீங்கள்",
            "ક્યાં" to "எங்கே", "શું" to "என்ன", "જોઈએ" to "தேவை",
            "બચાવ" to "மீட்பு", "દળ" to "குழு", "શાંત" to "அமைதி",
            "બધા" to "அனைவரும்", "ઘર" to "வீடு"
        )
    )
    ...
    fun translate(text: String, src: String, tgt: String): String? {
        ...
        for (p in PHRASES) {
            val from = when (src) { "hi" -> p.hi; "ta" -> p.ta; "bn" -> p.bn; "gu" -> p.gu; else -> null }
            if (from != null && from.isNotEmpty() && normalize(from) == norm) {
                val to = when (tgt) { "hi" -> p.hi; "ta" -> p.ta; "bn" -> p.bn; "gu" -> p.gu; else -> null }
                if (to != null && to.isNotEmpty()) return to else if (to != null) return null
            }
        }
